...
window.addEventListener('load', async () => {
  // Uruchom inicjalizację bazy w tle — nie blokuje ładowania UI!
  DB.init().catch(e => console.error("DB.init failed:", e));

  // Schowaj splash NATYCHMIAST — nie czekaj na bazę danych
