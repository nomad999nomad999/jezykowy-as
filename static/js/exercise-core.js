...
const Exercise = {
  ...
  async start(type) {
    ...
    else if (type === 'sentence_translation') await this.startSentenceTranslation();
    else if (type === 'debate_it') await this.startDebate();
  },
