...
Object.assign(Exercise, {
            ...
            ${m.feedback ? `
              <div class="chat-feedback-box">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px">
                  <span style="color:var(--text3);font-size:11px">Ocena AI:</span>
                  <span class="chat-feedback-score" style="color:${m.feedback.score >= 80 ? 'var(--green)' : m.feedback.score >= 50 ? 'var(--yellow)' : 'var(--red)'}">${m.feedback.score}/100</span>
                </div>
  ...
  _dialogueStartListening() {
    ...
    if (!SpeechRecognition) {
      // Automatyczny fallback – włącz klawiaturę zamiast alertu
    ...
    recognition.onerror = (event) => {
      ...
      if (event.error === 'not-allowed') {
        // Automatyczny fallback do klawiatury + banner informacyjny
  ...
  // Automatyczny przełącznik do trybu klawiatury z komunikatem
  ...
  _dialogueShowResult() {
    ...
    document.getElementById('modalBody').innerHTML = `
      <div style="text-align:center;padding:30px 20px">
        ...
        <p style="color:var(--text3);font-size:14px;margin-bottom:12px">Wypowiedzi: ${this.total} · Średni wynik: ${avgScore}/100</p>
